...
class Sentence_Embedding(nn.Module):
    def __init__(self,
                 ...
                 word2vec_path='/home/hjlee/workspace/Github/awesome-tv/MIL-NCE/datasets/data/dict.npy',
                 max_words=16,
                 output_dim=2048):
    ...
    def forward(self, x, raw_text=False):
        ...
        x = th.max(x, dim=1)[0]
        x = self.fc2(x)
        return x # text embedding


class S3D(nn.Module):

    def __init__(self, num_classes=512, gating=True, space_to_depth=False,
                  word2vec_path='/home/hjlee/workspace/Github/awesome-tv/MIL-NCE/datasets/data/word2vec.pth',
                  init='uniform',
                  token_to_word_path='/home/hjlee/workspace/Github/MIL-NCE_HowTo100M/data/dict.npy'):
        ...
        self.text_module = Sentence_Embedding(
                               num_classes,
                               token_to_word_path = token_to_word_path,
